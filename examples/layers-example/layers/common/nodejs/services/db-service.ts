...
/**
 * Database service for handling database connections and queries
 */
export class DbService {
     ...
     */
    private async createConnectionPool(): Promise<Pool> {
        try {
     ...
     */
    private async validateConnectionPool(pool: Pool): Promise<boolean> {
    ...
    async getConnectionPool(): Promise<Pool> {
        ...
        if (!connectionPool) {
            ...
            connectionPool = await this.createConnectionPool();
            return connectionPool;
        }
        
        // Validate existing pool
        const isValid = await this.validateConnectionPool(connectionPool);
